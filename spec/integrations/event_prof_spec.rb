...
describe "EventProf" do
  specify "RSpec integration", :aggregate_failures do
    output = run_rspec('event_prof_rspec_fixture.rb', env: { 'EVENT_PROF' => 'test.event' })
    ...
    expect(output).to include(
      "Another something (./event_prof_rspec_fixture.rb:42) – 16:40.000 (1 / 2)\n"\
      "Something (./event_prof_rspec_fixture.rb:21) – 09:16.100 (7 / 3)"
    )

    expect(output).to include(
      "do very long (./event_prof_rspec_fixture.rb:47) – 16:40.000 (1)\n"\
      "invokes twice (./event_prof_rspec_fixture.rb:27) – 06:20.000 (2)\n"\
      "invokes many times (./event_prof_rspec_fixture.rb:33) – 02:16.000 (4)\n"\
      "invokes once (./event_prof_rspec_fixture.rb:22) – 00:40.100 (1)"
    )
  end

  specify "RSpec integration with rank by count", :aggregate_failures do
    output = run_rspec(
      'event_prof_rspec_fixture.rb',
